    ...
    <section class="desc">
        ...
        <div class="container d-flex flex-row align-items-center justify-content-between">
            <div class="desc-items text-center">
                <h1>Product Ardy Bakery</h1>
                <p class="px-5 py-4">
                    Selamat datang di Toko Ardy Bakery, kami siap melayani anda dengan banyaknya jenis kue lezat untuk acara istimewa anda dan orang yang anda cinta
                </p>
            </div>
        </div>
    ...
    <section class="list-products mt-5 p-5" style="height: 100vh;">
        ...
        <!-- <div class="container d-flex flex-row align-items-center justify-content-between ">
            ...
            <div class="desc-products text-center">
                <h1>List Product Ardy Bakery</h1>
                <p class="py-3">
