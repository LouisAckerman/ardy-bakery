    ...
    <footer class="footer" id="contact">
        <div class="box-container">
            <div class="mainBox">
                ...
                <p>Jln. Lippo Cikarang mwah</p><hr><br>
            ...
            <div class="box">
                <h3>Our Contact</h3>
                <a href="<?= base_url('pages/contact')?>"> <i class="fas fa-phone"></i>(082110964407, WA only)</a>
                <a href="<?= base_url('pages/contact')?>"> <i class="fas fa-envelope"></i>ardybakery@shop.com</a>
        ...
        <div class="credit">
           @2023 <span>Copyright Ardy Bakery</span> | All Rights and Copyrights Reserved  
        </div>
    </footer>
